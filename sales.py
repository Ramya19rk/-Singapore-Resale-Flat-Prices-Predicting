...
data = pd.read_csv('Singapore_MRT.csv')
...
if selected == 'Home':
    ...
    with col2:
        col2.markdown("# ")
        col2.markdown("# ")
        col2.image("/Users/arul/Downloads/sin1.jpg")
        col2.markdown("# ")
        col2.image("/Users/arul/Downloads/sin2.jpg")
...
if selected == 'Resale Price':
    ...
    try:
        with st.form("form1"):
            ...
            street_name_df = pd.read_csv('street_name.csv')
            ...
            block_no_df = pd.read_csv('block.csv')
